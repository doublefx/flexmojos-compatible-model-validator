...
To use it, place the generated jar-file into ${MAVEN_HOME}/lib/ext or add this extension to your parent project pom, it will fail at the first build time and then run normally.
